...
--
-- Хост: localhost
-- Время создания: Дек 14 2012 г., 21:59
...
INSERT INTO `categories` (`id`, `category_title`, `parent_id`, `lft`, `rgt`, `lvl`, `scope`, `category_description`, `meta_description`, `meta_keywords`, `template`) VALUES
(1, 'Компьютеры', 0, 1, 2, 1, 1, '', 'Компьютеры', 'Компьютеры', ''),
(2, 'Ноутбуки', 0, 1, 4, 1, 2, '', '', '', 'products_column'),
(8, 'Мониторы', 0, 1, 2, 1, 3, '', '', '', 'products_list');
...
(43, 42, 'q8iabzm1ld6405y9.jpg'),
(44, 41, 'prkqczayb1mtgin9.jpg'),
(45, 40, 'ohvn5yf1jlext86s.jpg'),
(46, 43, 'muvkbfrn1a9zgwix.jpg'),
(47, 44, 'z3rm6xe78k5ayd41.jpg'),
(48, 44, 'l07rh6jqatvkufo3.jpg'),
(49, 45, 'i4o5dn1h6mvwgsfp.jpg'),
(50, 45, 'qsku78v05jenbghy.jpg'),
(51, 48, 'kzf0oxrv16ce7m42.jpg'),
(52, 49, 'ey8x4bn5w2f60pmi.jpg'),
(53, 50, 'isfucd3a12675eq8.jpg'),
(54, 51, 'vy6s5zdgmf92bhul.jpg');
...
CREATE TABLE IF NOT EXISTS `menus` (
  ...
  `menu_alias` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `menus` (`menu_id`, `menu_group_id`, `menu_type`, `menu_title`, `menu_alias`, `menu_url`) VALUES
(1, 1, 'url', 'Главная', '', ''),
(2, 1, 'url', 'Личный кабинет', 'login', ''),
(3, 1, 'pages/page', 'Доставка', 'delivery', ''),
(4, 1, 'url', 'Статьи', 'articles', ''),
(5, 1, 'pages/page', 'О Нас', 'about', '');
...
CREATE TABLE IF NOT EXISTS `menu_groups` (
  ...
  `menu_group_title` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `menu_group_position` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `menu_groups` (`menu_group_id`, `menu_group_title`, `menu_group_position`) VALUES
(1, 'Верхний Меню', 'top'),
(2, 'Левый Меню', '');
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `order_date` varchar(12) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `orders_product` (`order_product_id`, `orders_user_id`, `product_id`) VALUES
(1, 6, 46);
...
INSERT INTO `pages` (`page_id`, `page_title`, `page_alias`, `page_text`, `page_description`, `page_keywords`) VALUES
...
INSERT INTO `payment_metods` (`payment_id`, `payment_title`, `kashelyok`, `payment_html`) VALUES
(2, 'Оплата Яндекс.Деньги', 1234567891234656, '');
...
INSERT INTO `products` (`id`, `manufacture_id`, `title`, `code`, `description`, `price`, `meta_description`, `meta_keywords`, `contity`, `status`, `image_id`, `add_date`) VALUES
(44, 1, 'Компьютер OLDI Office Pro 140 >Pentium G620/4Gb/500Gb/SVGA/DVD±RW/CR/Win7 Pro 64-bit', 2, '<p>Лицензионная Microsoft Windows 7 Профессиональная 64-бит</p>\n<p>Intel Pentium G620 (Sandy Bridge, 2.6 ГГц, 3Мб L3),&nbsp;4 Гб DDR3,&nbsp;Интегрирована в процессор Intel HD Graphics,500 Гб (SATA III)&nbsp;,&nbsp;CardReader (SD/CF/xD/MMC/MS),&nbsp;</p>\n<table>\n<tbody>\n<tr>\n<td><strong>Процессор</strong></td>\n<td>Intel Pentium G620 (Sandy Bridge, 2.6 ГГц, 3Мб L3)</td>\n<td><strong>Оперативная память</strong></td>\n<td>4 Гб DDR3</td>\n</tr>\n<tr>\n<td><strong>Жесткий диск</strong></td>\n<td>500 Гб (SATA III)</td>\n<td><strong>Видеокарта</strong></td>\n<td>Интегрирована в процессор Intel HD Graphics</td>\n</tr>\n<tr>\n<td><strong>Устройство чтения карт памяти</strong></td>\n<td>CardReader (SD/CF/xD/MMC/MS)</td>\n<td><strong>Разъемы</strong></td>\n<td>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>1 x D-Sub, 4 x USB 2.0</div>\n</td>\n</tr>\n<tr>\n<td><strong>Оптические накопители</strong></td>\n<td>DVD&plusmn;RW</td>\n<td><strong>Тип корпуса</strong></td>\n<td>Mid Tower</td>\n</tr>\n<tr>\n<td><strong>Сетевая карта</strong></td>\n<td>10/100/1000 Мбит/с</td>\n<td><strong>Звуковая карта</strong></td>\n<td>6-канальная</td>\n</tr>\n<tr>\n<td><strong>Операционная система</strong></td>\n<td>Лицензионная Microsoft Windows 7 Профессиональная 64-бит</td>\n<td><strong>Офисное ПО</strong></td>\n<td>Бесплатный выпуск Microsoft&reg; Office 2010 Starter (Word и Excel с ограниченной функциональностью)</td>\n</tr>\n<tr>\n<td><strong>Антивирусное ПО</strong></td>\n<td>Бесплатный антивирус Microsoft&reg; Security Essentials</td>\n<td><strong>Размеры</strong></td>\n<td>420 мм х 180 мм х 380 мм</td>\n</tr>\n<tr>\n<td><strong>Вес</strong></td>\n<td>6.659 кг</td>\n<td><strong>Информация для покупателя</strong></td>\n<td>За более подробной информацией вы можете обратиться к нашим специалистам тел. +7(495) 22-11-111 , oldi@oldi.ru Также вы можете воспользоваться услугами&nbsp;<a href="http://www.oldi.ru/catalog/6625/">Мобильного Сервиса</a></td>\n</tr>\n<tr>\n<td><strong>Срок гарантии</strong></td>\n<td>36 мес.</td>\n</tr>\n</tbody>\n</table>', 13157, 'Компьютер OLDI Office Pro 140 >Pentium G620/4Gb/500Gb/SVGA/DVD±RW/CR/Win7 Pro 64-bit', 'Компьютер OLDI Office Pro 140 Pentium G620/4Gb/500Gb/SVGA/DVD±RW/CR/Win7', 0, 1, 47, '0000-00-00'),
(45, 1, 'Платформа FOXCONN nT-i1500 (Black)', 1, '<p>Intel Atom D2700 (Cedarview-D, 2.13 ГГц, 1Mб L2 ),&nbsp;Интегрирована в процессор Intel HD Graphics,&nbsp;CardReader (SD/SDHC/MS/MS Pro/MMC) ,&nbsp;Один слот для ОЗУ SO-DIMM DDR3 (до 1066 МГц, до 4 Гб),&nbsp;Отсек для HDD/SSD 2.5" SATA2,&nbsp;S/PDIF-IN совместим со входом микрофона</p>\n<table>\n<tbody>\n<tr>\n<td><strong>Процессор</strong></td>\n<td>Intel Atom D2700 (Cedarview-D, 2.13 ГГц, 1Mб L2 )</td>\n<td><strong>Количество ядер</strong></td>\n<td>2</td>\n</tr>\n<tr>\n<td><strong>Оперативная память</strong></td>\n<td>Отсутствует</td>\n<td><strong>Жесткий диск</strong></td>\n<td>Отсутствует</td>\n</tr>\n<tr>\n<td><strong>Видеокарта</strong></td>\n<td>Интегрирована в процессор Intel HD Graphics</td>\n<td><strong>Устройство чтения карт памяти</strong></td>\n<td>CardReader (SD/SDHC/MS/MS Pro/MMC)</td>\n</tr>\n<tr>\n<td><strong>Разъемы</strong></td>\n<td>\n<div>Express Card - Отсутствует</div>\n<div>1 x Разъём RJ-45</div>\n<div>1 x Наушники</div>\n<div>1 x HDMI</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>4 x USB 2.0</div>\n<div>1 x VGA</div>\n<div>1 x Микрофон</div>\n<div>2 х USB 3.0<br />1 x Line-out (совместим с S/PDIF-OUT)</div>\n</td>\n<td><strong>Экран</strong></td>\n<td>''''</td>\n</tr>\n<tr>\n<td><strong>Оптические накопители</strong></td>\n<td>Отсутствует</td>\n<td><strong>Тип корпуса</strong></td>\n<td>NetTop</td>\n</tr>\n<tr>\n<td><strong>Сетевая карта</strong></td>\n<td>10/100/1000 Мбит/с + WI-Fi</td>\n<td><strong>WiFi</strong></td>\n<td>802.11 b/g/n</td>\n</tr>\n<tr>\n<td><strong>BlueTooth</strong></td>\n<td>Отсутствует</td>\n<td><strong>Звуковая карта</strong></td>\n<td>Интегрированная</td>\n</tr>\n<tr>\n<td><strong>Операционная система</strong></td>\n<td>Не установлена</td>\n<td><strong>Дополнительно</strong></td>\n<td>Один слот для ОЗУ SO-DIMM DDR3 (до 1066 МГц, до 4 Гб)<br />Отсек для HDD/SSD 2.5" SATA2<br />S/PDIF-IN совместим со входом микрофона<br />Возможность крепления по стандарту VESA</td>\n</tr>\n<tr>\n<td><strong>Комплект поставки</strong></td>\n<td>NetTop, адаптер и кабель питания, диск с ПО, крепежный набор VESA, подставка</td>\n<td><strong>Питание</strong></td>\n<td>Внешний адаптер питания от сети переменного тока</td>\n</tr>\n<tr>\n<td><strong>Размеры</strong></td>\n<td>190 мм х 135 мм х 24 мм</td>\n<td><strong>Срок гарантии</strong></td>\n<td>12 мес.</td>\n</tr>\n</tbody>\n</table>', 5672, '', '', 0, 1, 49, '0000-00-00'),
(48, 3, 'Монитор 19" Samsung E1920NR (LASB) TFT, 1280x1024, 5мс, 250(кд/кв.м), DC 50000:1(1000:1), D-SUB', 142243, '<table>\n<tbody>\n<tr>\n<td><strong>Тип</strong></td>\n<td>ЖК - монитор</td>\n<td><strong>Тип матрицы</strong></td>\n<td>TN</td>\n</tr>\n<tr>\n<td><strong>Экран</strong></td>\n<td>\n<div><em>Размер:&nbsp;</em>19" (48.3 см)</div>\n<div><em>Разрешение матрицы:&nbsp;</em>1280 х 1024</div>\n</td>\n<td><strong>Размер пикселя</strong></td>\n<td>0.294 мм</td>\n</tr>\n<tr>\n<td><strong>Яркость</strong></td>\n<td>250 кд/кв.м</td>\n<td><strong>Контрастность</strong></td>\n<td>1 000:1 - статическая<br />50 000:1 - динамическая</td>\n</tr>\n<tr>\n<td><strong>Время отклика</strong></td>\n<td>5 мс.</td>\n<td><strong>Угол обзора по вертикали (?)</strong></td>\n<td>170</td>\n</tr>\n<tr>\n<td><strong>Угол обзора по горизонтали (?)</strong></td>\n<td>160</td>\n<td><strong>Частота вертикальной развертки</strong></td>\n<td>56 - 75 Гц</td>\n</tr>\n<tr>\n<td><strong>Частота горизонтальной развертки</strong></td>\n<td>30 - 81 кГц</td>\n<td><strong>Полоса пропускания видеосигнала</strong></td>\n<td>135 МГц</td>\n</tr>\n<tr>\n<td><strong>Управление</strong></td>\n<td>Кнопочное</td>\n<td><strong>Динамики</strong></td>\n<td>Отсутствуют</td>\n</tr>\n<tr>\n<td><strong>USB концентратор</strong></td>\n<td>Отсутствует</td>\n<td><strong>Разъемы</strong></td>\n<td>\n<div>1 x VGA</div>\n<div>DVI - Отсутствует</div>\n<div>HDMI - Отсутствует</div>\n<div>DisplayPort - Отсутствует</div>\n</td>\n</tr>\n<tr>\n<td><strong>Крепление на кронштейн (стандарт VESA)</strong></td>\n<td>VESA 75 x 75 мм</td>\n<td><strong>Питание</strong></td>\n<td>Встроенный адаптер питания от сети переменного тока</td>\n</tr>\n<tr>\n<td><strong>Потребляемая мощность</strong></td>\n<td>В рабочем режиме 22 Вт<br />В режиме ожидания менее 0.3 Вт.</td>\n<td><strong>Дополнительно</strong></td>\n<td>Матовая поверхность экрана</td>\n</tr>\n<tr>\n<td><strong>Тип упаковки</strong></td>\n<td>Retail</td>\n<td><strong>Комплект поставки</strong></td>\n<td>Монитор, руководство пользователя, кабель VGA, кабель питания, подставка с соединительным элементом, ПО</td>\n</tr>\n<tr>\n<td><strong>Размеры монитора с подставкой</strong></td>\n<td>417.2 мм х 179.8 мм х 426.4 мм</td>\n<td><strong>Вес монитора с подставкой</strong></td>\n<td>4.2 кг</td>\n</tr>\n<tr>\n<td><strong>Размеры упаковки</strong></td>\n<td>120 x 490 x 420 мм</td>\n<td><strong>Вес упаковки</strong></td>\n<td>5.3 кг</td>\n</tr>\n<tr>\n<td><strong>Срок гарантии</strong></td>\n<td>24 мес. с/ц.</td>\n</tr>\n</tbody>\n</table>', 4920, '', '', 0, 1, 51, '0000-00-00'),
(49, 3, 'Монитор 18,5" Samsung S19B300B (300BS), LED, 1366x768, 5ms, 250cd/m2, Mega DCR, 1000:1, D-sub, DVI', 187153, '<table>\n<tbody>\n<tr>\n<td><strong>Тип</strong></td>\n<td>ЖК - монитор с LED подсветкой</td>\n<td><strong>Тип матрицы</strong></td>\n<td>TN</td>\n</tr>\n<tr>\n<td><strong>Экран</strong></td>\n<td>\n<div><em>Размер:&nbsp;</em>18.5" (47 см)</div>\n<div><em>Разрешение матрицы:&nbsp;</em>1366 х 768</div>\n</td>\n<td><strong>Яркость</strong></td>\n<td>250 кд/кв.м</td>\n</tr>\n<tr>\n<td><strong>Контрастность</strong></td>\n<td>1 000:1 - статическая<br />MEGA DCR - динамическая</td>\n<td><strong>Время отклика</strong></td>\n<td>5 мс.</td>\n</tr>\n<tr>\n<td><strong>Угол обзора по вертикали (?)</strong></td>\n<td>160</td>\n<td><strong>Угол обзора по горизонтали (?)</strong></td>\n<td>170</td>\n</tr>\n<tr>\n<td><strong>Управление</strong></td>\n<td>Сенсорные кнопки</td>\n<td><strong>Динамики</strong></td>\n<td>Отсутствуют</td>\n</tr>\n<tr>\n<td><strong>USB концентратор</strong></td>\n<td>Отсутствует</td>\n<td><strong>Разъемы</strong></td>\n<td>\n<div>VGA</div>\n<div>DVI</div>\n<div>HDMI - Отсутствует</div>\n<div>DisplayPort - Отсутствует</div>\n</td>\n</tr>\n<tr>\n<td><strong>Крепление на кронштейн (стандарт VESA)</strong></td>\n<td>Отсутствует</td>\n<td><strong>Питание</strong></td>\n<td>Внешний адаптер питания</td>\n</tr>\n<tr>\n<td><strong>Потребляемая мощность</strong></td>\n<td>В рабочем режиме 20 Вт<br />В режиме ожидания менее 0.3 Вт.</td>\n<td><strong>Дополнительно</strong></td>\n<td>Регулировка положения экрана: наклон</td>\n</tr>\n<tr>\n<td><strong>Тип упаковки</strong></td>\n<td>Retail</td>\n<td><strong>Комплект поставки</strong></td>\n<td>Монитор, адаптер и кабель питания, кабель VGA, установочный CD, E-руководство, краткая инструкция</td>\n</tr>\n<tr>\n<td><strong>Размеры монитора без подставки</strong></td>\n<td>\n<div>445 x 273 x 53 мм</div>\n</td>\n<td><strong>Размеры монитора с подставкой</strong></td>\n<td>445 мм х 177 мм х 348 мм</td>\n</tr>\n<tr>\n<td><strong>Вес монитора без подставки (кг)</strong></td>\n<td>\n<div>2.1</div>\n</td>\n<td><strong>Вес монитора с подставкой</strong></td>\n<td>2.3 кг</td>\n</tr>\n<tr>\n<td><strong>Размеры упаковки</strong></td>\n<td>105 x 520 x 405 мм</td>\n<td><strong>Вес упаковки</strong></td>\n<td>3.34 кг</td>\n</tr>\n<tr>\n<td><strong>Срок гарантии</strong></td>\n<td>24 мес. с/ц.</td>\n</tr>\n</tbody>\n</table>\n<div class="txt"><strong>Характеристики изделия могут изменяться производителем без предварительного уведомления</strong></div>\n<p class="abuse"><a class="abuselink_F_DESCRIPTION local" href="http://www.oldi.ru/catalog/element/0187153/">пожаловаться на описание</a>&nbsp;<strong>:)</strong></p>', 3334, '', '', 0, 1, 52, '0000-00-00'),
(50, 43, 'Ноутбук Dell Inspiron 5520 (5520-5315) Red i5-3210M/6G/500G/DVD-SMulti/15,6"HD/ATI 7670M 1G/WiFi/BT/cam/Win7HB', 142244, '<table>\n<tbody>\n<tr>\n<td><strong>Описание</strong></td>\n<td><img src="http://www.oldi.ru/i/logo/dell.jpg" alt="" border="0" /><img src="http://www.oldi.ru/i/logo/windows7hb.jpg" alt="" border="0" /></td>\n</tr>\n</tbody>\n</table>\n<table>\n<tbody>\n<tr>\n<td><strong>Процессор</strong></td>\n<td>\n<div>Наименование процессора:<em><span style="text-decoration: underline;">Intel Core i5 3210M (Ivy Bridge, 3Mb L3 Cache)</span></em></div>\n<div>Частота:&nbsp;<em><span style="text-decoration: underline;">2.50 ГГц</span></em></div>\n<div>Двухъядерный / Четырехпоточный<br />Поддержка технологии Turbo Boost (Увеличение частоты ЦП до 3.1 ГГц)<br />Встроенное графическое ядро</div>\n</td>\n<td><strong>Экран</strong></td>\n<td>\n<div>Диагональ дисплея:&nbsp;<em><span style="text-decoration: underline;">15.6 ''''</span></em></div>\n<div>Разрешение дисплея:&nbsp;<em><span style="text-decoration: underline;">1366 x 768 (HD-Ready)</span></em></div>\n</td>\n</tr>\n<tr>\n<td><strong>Чипсет</strong></td>\n<td>Intel&reg; HM77</td>\n<td><strong>Оперативная память</strong></td>\n<td>\n<div>Установленная оперативная память:&nbsp;<em><span style="text-decoration: underline;">6 Гб</span></em></div>\n<div>Тип оперативной памяти:&nbsp;<em><span style="text-decoration: underline;">SO-DIMM DDR3</span></em></div>\n<div>&nbsp;</div>\n</td>\n</tr>\n<tr>\n<td><strong>Постоянная память (HDD / SSD / Flash)</strong></td>\n<td>\n<div>Объем постоянной памяти:&nbsp;<em><span style="text-decoration: underline;">500 Гб</span></em></div>\n<div>Тип устройства:&nbsp;<em><span style="text-decoration: underline;">2,5" HDD (5400 rpm)</span></em></div>\n<div>Интерфейс: SATA-II</div>\n<div>Дополнительное устройство: отсутствует</div>\n</td>\n<td><strong>Видеокарта</strong></td>\n<td>\n<div>Дискретная (Отдельный чип) - AMD Mobility Radeon HD7670 (1024 МБ)</div>\n</td>\n</tr>\n<tr>\n<td><strong>Устройство чтения карт памяти</strong></td>\n<td>SD, SDXC, SDHC, MMC+, Memory Stick PRO, xD</td>\n<td><strong>Оптические накопители</strong></td>\n<td>DVD SuperMulti</td>\n</tr>\n<tr>\n<td><strong>Звуковая подсистема</strong></td>\n<td>Встроенные стереодинамики</td>\n<td><strong>Сетевая карта</strong></td>\n<td>10/100 Мбит/сек</td>\n</tr>\n<tr>\n<td><strong>WiFi</strong></td>\n<td>Поддержка Wi-Fi (b/g/n)</td>\n<td><strong>WiMax</strong></td>\n<td>Wimax не поддерживается</td>\n</tr>\n<tr>\n<td><strong>BlueTooth</strong></td>\n<td>Поддержка Bluetooth: версия 4.0</td>\n<td><strong>Вебкамера</strong></td>\n<td>1 МПикс</td>\n</tr>\n<tr>\n<td><strong>Питание</strong></td>\n<td>Внешний адаптер питания от сети переменного тока<br />6-элементный литий-ионный аккумулятор емкостью 48 Вт/ч</td>\n<td><strong>Программное обеспечение</strong></td>\n<td>\n<div>Лицензионная Microsoft Windows 7 Home Basic (64-разрядная версия)</div>\n</td>\n</tr>\n<tr>\n<td><strong>Цвет</strong></td>\n<td>\n<div>Красный</div>\n<div>Красный цвет крышки</div>\n</td>\n<td><strong>Разъемы</strong></td>\n<td>\n<div>1 x VGA</div>\n<div>USB 2.0 - Отсутствует</div>\n<div>4 x USB 3.0</div>\n<div>1 x Разъём RJ-45</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>1 x HDMI</div>\n<div>Express Card - Отсутствует</div>\n<div>eSATA - Отсутствует</div>\n<div>IEEE1394 - Отсутствует</div>\n</td>\n</tr>\n<tr>\n<td><strong>Тип упаковки</strong></td>\n<td>Retail</td>\n<td><strong>Комплект поставки</strong></td>\n<td>Ноутбук, аккумулятор, адаптер питания</td>\n</tr>\n<tr>\n<td><strong>Размеры (Д х Ш х В)</strong></td>\n<td>378 мм х 252 мм х 34 мм</td>\n<td><strong>Вес</strong></td>\n<td>2.74 кг</td>\n</tr>\n<tr>\n<td><strong>Размеры упаковки</strong></td>\n<td>335 x 490 x 100 мм</td>\n<td><strong>Вес упаковки</strong></td>\n<td>4.26 кг</td>\n</tr>\n<tr>\n<td><strong>Срок гарантии</strong></td>\n</tr>\n</tbody>\n</table>', 15500, 'Ноутбук Dell Inspiron 5520 (5520-5315) Red i5-3210M/6G/500G/DVD-SMulti/15,6"HD/ATI 7670M 1G/WiFi/BT/cam/Win7HB', 'Ноутбук Dell Inspiron 5520 (5520-5315) Red i5-3210M/6G/500G/DVD-SMulti/15,6"HD/ATI 7670M 1G/WiFi/BT/cam/Win7HB', 0, 1, 53, '0000-00-00'),
(51, 1, 'Ноутбук Asus X501A B970/2G/320G/15.6"HD/WiFi/BT/camera/Win7 HB Black', 1458903, '<table>\n<tbody>\n<tr>\n<td><strong>Процессор</strong></td>\n<td>\n<div>Наименование процессора:<em><span style="text-decoration: underline;">Intel Pentium B970 (Sandy Bridge, DMI, 2M L3 Cache)</span></em></div>\n<div>Частота:&nbsp;<em><span style="text-decoration: underline;">2.30 ГГц</span></em></div>\n<div>Двухъядерный<br />Встроенное графическое ядро</div>\n</td>\n<td><strong>Экран</strong></td>\n<td>\n<div>Диагональ дисплея:&nbsp;<em><span style="text-decoration: underline;">15.6 ''''</span></em></div>\n<div>Разрешение дисплея:&nbsp;<em><span style="text-decoration: underline;">1366 x 768 (HD-Ready)</span></em></div>\n</td>\n</tr>\n<tr>\n<td><strong>Чипсет</strong></td>\n<td>Intel HM70</td>\n<td><strong>Оперативная память</strong></td>\n<td>\n<div>Установленная оперативная память:&nbsp;<em><span style="text-decoration: underline;">2 Гб</span></em></div>\n<div>Тип оперативной памяти:&nbsp;<em><span style="text-decoration: underline;">SO-DIMM DDR3</span></em></div>\n<div>&nbsp;</div>\n</td>\n</tr>\n<tr>\n<td><strong>Постоянная память (HDD / SSD / Flash)</strong></td>\n<td>\n<div>Объем постоянной памяти:&nbsp;<em><span style="text-decoration: underline;">320 Гб</span></em></div>\n<div>Тип устройства:&nbsp;<em><span style="text-decoration: underline;">2,5" HDD (5400 rpm)</span></em></div>\n<div>Интерфейс: SATA-II</div>\n<div>Дополнительное устройство: отсутствует</div>\n</td>\n<td><strong>Видеокарта</strong></td>\n<td>\n<div>Интегрированная - Intel HD Graphics</div>\n</td>\n</tr>\n<tr>\n<td><strong>Устройство чтения карт памяти</strong></td>\n<td>SD / MMC</td>\n<td><strong>Оптические накопители</strong></td>\n<td>Отсутствует</td>\n</tr>\n<tr>\n<td><strong>Звуковая подсистема</strong></td>\n<td>Встроенные стереодинамики</td>\n<td><strong>Сетевая карта</strong></td>\n<td>10/100/1000 Мбит/сек</td>\n</tr>\n<tr>\n<td><strong>WiFi</strong></td>\n<td>Поддержка Wi-Fi (b/g/n)</td>\n<td><strong>WiMax</strong></td>\n<td>Wimax не поддерживается</td>\n</tr>\n<tr>\n<td><strong>BlueTooth</strong></td>\n<td>Поддержка Bluetooth: версия 4.0</td>\n<td><strong>Вебкамера</strong></td>\n<td>0.3 МПикс</td>\n</tr>\n<tr>\n<td><strong>Питание</strong></td>\n<td>Внешний адаптер питания от сети переменного тока<br />6-ячеечный аккумулятор 4400 мАч</td>\n<td><strong>Программное обеспечение</strong></td>\n<td>\n<div>Лицензионная Microsoft Windows 7 Home Basic (64-разрядная версия)</div>\n</td>\n</tr>\n<tr>\n<td><strong>Цвет</strong></td>\n<td>\n<div>Черный</div>\n<div>&nbsp;</div>\n</td>\n<td><strong>Разъемы</strong></td>\n<td>\n<div>1 x VGA</div>\n<div>1 x USB 2.0</div>\n<div>1 x USB 3.0</div>\n<div>1 x Разъём RJ-45</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>&nbsp;</div>\n<div>1 x HDMI</div>\n<div>Express Card - Отсутствует</div>\n<div>eSATA - Отсутствует</div>\n<div>IEEE1394 - Отсутствует</div>\n</td>\n</tr>\n<tr>\n<td><strong>Тип упаковки</strong></td>\n<td>Retail</td>\n<td><strong>Комплект поставки</strong></td>\n<td>Ноутбук, адаптер и кабель питания</td>\n</tr>\n<tr>\n<td><strong>Размеры (Д х Ш х В)</strong></td>\n<td>380 мм х 253 мм х 32.3 мм</td>\n<td><strong>Вес</strong></td>\n<td>2.07 кг</td>\n</tr>\n<tr>\n<td><strong>Размеры упаковки</strong></td>\n<td>295 x 430 x 85 мм</td>\n<td><strong>Вес упаковки</strong></td>\n<td>2.84 кг</td>\n</tr>\n<tr>\n<td><strong>Срок гарантии</strong></td>\n<td>1г. с/ц</td>\n</tr>\n</tbody>\n</table>', 14846, 'Ноутбук Asus X501A B970/2G/320G/15.6"HD/WiFi/BT/camera/Win7 HB Black', 'Ноутбук Asus X501A B970/2G/320G/15.6"HD/WiFi/BT/camera/Win7 HB Black', 0, 1, 54, '0000-00-00');
...
INSERT INTO `settings` (`setting_id`, `url`, `title`, `meta_description`, `meta_keywords`) VALUES
(1, 'http://norshopcms/', 'Интернет магазин', 'Интернет магазин', 'Интернет магазин');
...
(20, 'admin@norshopcms.loc', 'admin', 'e38ddda096cc066ae2c56527c668881ca34ddc6d0926e2092d4ef5f92b7b752a', 'Администратор', '8926585685', 'sdfdsfdsfds', 176, 2722, '0000-00-00', 1, 0, 1355321009);
